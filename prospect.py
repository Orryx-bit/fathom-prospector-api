    ...
    def process_practice(self, place_data: Dict) -> Optional[Dict]:
        ...
        final_record = {
            **practice_record,
            ...
            'universal_aesthetic_breakdown': practice_record.get('universal_aesthetic_breakdown', {}),
            'manufacturer_opportunity_breakdown': practice_record.get('manufacturer_opportunity_breakdown', {}),
            'best_device_match': practice_record.get('manufacturer_opportunity_breakdown', {}).get('best_device', 'Not specified'),
